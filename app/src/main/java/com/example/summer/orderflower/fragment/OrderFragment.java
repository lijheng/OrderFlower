...
public class OrderFragment extends Fragment {
    ...
    //ListView
    private static View view;//用于记录view
    private ListView orderListView;
    private SimpleAdapter orderSimpleAdapter;
    private List<Map<String,Object>> orderListData;
...
//        当系统版本在4.0及以上时
        if (Build.VERSION.SDK_INT>=Build.VERSION_CODES.KITKAT){
            ...
            LinearLayout linearLayout = (LinearLayout) view.findViewById(R.id.order_bar);
